...
"""
Database initialization script - create table structure and insert initial data
"""
import pymysql
import bcrypt
...
def create_tables():
    ...
    try:
        with connection.cursor() as cursor:
            ...
            """)
            print("✓ Created program_enrollments table")
            ...
            """)
            print("✓ Created content_library table")
            
            # 10. Species_Sightings table
            cursor.execute("""
            ...
            """)
            print("✓ Created species_sightings table")
            ...
            """)
            print("✓ Created creative_canvas table")
            
            # 17. Access_Logs table
            cursor.execute("""
    ...
    try:
        with connection.cursor() as cursor:
            ...
            cursor.executemany("""
                ...
                VALUES (%s, %s, %s, %s, %s, %s)
            """, organizations_data)
            print(f"✓ Inserted {len(organizations_data)} organizations")
            
            # 3. Insert organization members
            org_members_data = [
            ...
            cursor.executemany("""
                ...
                VALUES (%s, %s, %s, %s, %s)
            """, org_members_data)
            print(f"✓ Inserted {len(org_members_data)} organization member relations")
            ...
            cursor.executemany("""
                ...
                VALUES (%s, %s, %s)
            """, programs_data)
            print(f"✓ Inserted {len(programs_data)} protection programs")
            ...
            cursor.executemany("""
                ...
                VALUES (%s, %s, %s, %s)
            """, class_enrollments_data)
            print(f"✓ Inserted {len(class_enrollments_data)} class enrollment records")
            
            # 7. Insert program enrollments
            program_enrollments_data = [
                ...
                # Community registration for programs
            ...
            cursor.executemany("""
                ...
                VALUES (%s, %s, %s, %s, %s)
            """, program_enrollments_data)
            print(f"✓ Inserted {len(program_enrollments_data)} program enrollment records")
            ...
            user_profiles_data = [
                ...
                # Community member profiles (public)
            ...
            cursor.executemany("""
                ...
                VALUES (%s, %s, %s, %s, %s)
            """, user_profiles_data)
            print(f"✓ Inserted {len(user_profiles_data)} user profiles")
            
            # 10. Insert content library
            content_library_data = [
                # School library content (student work)
            ...
            cursor.executemany("""
                ...
                VALUES (%s, %s, %s, %s, %s, %s)
            """, content_library_data)
            print(f"✓ Inserted {len(content_library_data)} content library items")
            
            # 11. Insert species sightings
            ...
            """, species_sightings_data)
            print(f"✓ Inserted {len(species_sightings_data)} species sightings")
            ...
            cursor.executemany("""
                ...
                VALUES (%s, %s, %s, %s)
            """, assessments_data)
            print(f"✓ Inserted {len(assessments_data)} assessments")
            ...
            cursor.executemany("""
                ...
                VALUES (%s, %s, %s)
            """, canvas_data)
            print(f"✓ Inserted {len(canvas_data)} creative canvas records")
            
            # 17. Insert business analytics data
            analytics_data = [
            ...
            cursor.executemany("""
                ...
                VALUES (%s, %s, %s)
            """, analytics_data)
            print(f"✓ Inserted {len(analytics_data)} business analytics data")
...
def main():
    """Main function"""
    print("="*60)
    print("Komodo Hub Database Initialization")
    print("="*60 + "\n")

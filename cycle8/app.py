...
# Database connection configuration (consistent with backend)
class Database:
    def __init__(self):
...
# Utility functions (consistent with backend)
...
def submit_assignment():
    ...
    # Get activities available for submission
    db = Database()
...
def send_message():
    ...
    # Get user list (for selecting recipient)
    db = Database()

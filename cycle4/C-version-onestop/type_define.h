...
// One-stop platform uses student/employee ID for emails, length never exceeds 50 chars
typedef struct {
    char sender[10];
    char receiver[10];
    char topic[10];    
...
// Add new users: student, teacher, assistant, administrator
void add_new_student() {
	...
	printf("Please enter the new student password (default: name):\n");
...
void add_new_teacher() {
	...
	printf("Please enter the new teacher password (default: name):\n");
...
void add_new_assistant() {
	...
	printf("Please enter the new assistant password (default: name):\n");
...
void add_new_administrator() {
	...
	printf("Please enter the new administrator password (default: name):\n");
...
// Synchronize to four user type struct arrays
void synchronise_from_txt_to_students_array(Student students[]) {
	FILE* file;
	file = fopen("students.txt", "r");
	int num_students = 0;
...
// Synchronize emails and return number of emails
int get_num_emails_and_synchronise_from_txt_to_emails_array(Email emails[]) {
	FILE* file;
...
// Synchronize forums and return number of posts and build linked list
int get_num_forums_and_synchronise_from_txt_to_forums_array_and_create_chain(Forum forums[]) {
	FILE* file;

...
void visitors_operations(){
	printf("Launching visitor-side program\n");
	printf("Welcome to Communication University of China\n");
	printf("Visitors can perform the following functions: 1. View campus forum (read-only) 2. Apply for account (limited to new students/new staff)\n");
	int visitors_choice;
	...
	case 1:
		...
		break;
	case 2:
		printf("Please enter the relevant information for admin approval\n");
		printf("Please enter the student/staff number on your admission/employment letter: ");
		char newusername[10];
		scanf("%s", newusername);
